...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO tb_jarak (jarak, created_at) VALUES ('$jarak', NOW())";
                                    ...
                                    <div class="notif-center">
                                        <a href="#">
                                            ...
                                            <div class="notif-content">
                                                <span class="block">pH Air saat ini 30c</span>
                                        ...
                                        <a href="#">
                                            ...
                                            <div class="notif-content">
                                                <span class="block">Tanaman membutuhkan jarak</span>
            ...
            <div class="content">
                <div class="page-inner">
                    <div class="page-header">
                        <h4 class="page-title">Tabel Data Sensor Jarak</h4>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Tabel Data Sensor Jarak</h4>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="basic-datatables" class="display table table-striped table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                $sql = "SELECT jarak,created_at FROM tb_jarak";
