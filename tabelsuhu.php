...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO tb_suhu (suhu, created_at) VALUES ('$suhu', NOW())";
            ...
            <div class="content">
                <div class="page-inner">
                    <div class="page-header">
                        <h4 class="page-title">Tabel Data Sensor Suhu</h4>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Tabel Data Sensor Suhu</h4>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="basic-datatables" class="display table table-striped table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                $sql = "SELECT suhu,created_at FROM tb_suhu";
