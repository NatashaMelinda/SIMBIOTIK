                        ...
                        <div class="row">
                            <div class="col-lg-8 mx-auto poppins-font">
                                <div class="p-5">
                                    ...
                                    <hr> --}} -->
                                    <div class="text-center">
                                        <h1 class="h6 text-gray-900 mb-0" style="font-weight: bold;">Sistem Monitoring
                                            dan Kontrol Berbasis IoT</h1>
                                        <h1 class="h6 text-gray-900 mb-0" style="font-weight: bold;">Pada Aplikasi Web
                                            untuk Pertumbuhan Tanaman Hidroponik</h1>
                                    </div>
                                </div>
                            </div>
                        </div>
